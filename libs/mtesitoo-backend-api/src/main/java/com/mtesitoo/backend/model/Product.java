...
public class Product implements Parcelable {
    ...
    public boolean isCompleted() {
        ...
        //*******@Gwen added 4/16/2019
        //Check if UnitType was selected
        //App was crashing if no unit was selected
        if (isValidUnit)
        {
        ...
        //********@Gwen added 4/16/2019
        // Added validation for mQuantity  - All must be filled in order to submit
        return !mName.isEmpty() && !mDescription.isEmpty() && !mLocation.isEmpty() && ! mCategories.isEmpty() && mQuantity !=null
